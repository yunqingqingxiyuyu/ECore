...
{
    return QLatin1String("ECore");
}

QIcon ELineEditPlugin::icon() const
{
    return QIcon(QLatin1String(":/ELineEdit.png"));
}
...
{
    return QLatin1String("默认带有查询与删除按钮的输入框");
}
...
Q_EXPORT_PLUGIN2(elineeditplugin, ELineEditPlugin)
